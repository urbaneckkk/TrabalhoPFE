...
async function getNoticiasMobile(query) {
    try {
        ...
        const noticiasMobile = articlesMobile
        ...
        if (query === "todas") {
            todasNoticiasMobile = noticiasMobile;
            noticiasFiltradasMobile = [...todasNoticiasMobile];  // carrega todas as noticias
        } else {
            noticiasFiltradasMobile = noticiasMobile;  // carrega noticia do filtro selecionado
        }
